...
export class Building{
    constructor(scene){
        ...
        // this.createSphere0(this.config.createSphere)
        // this.createSphere1(this.config.createSphere)
        // this.createSphere2(this.config.createSphere)//展示凸局域分布情况
    }
    createSphere0(c){
        let self=this
        ...
        loader.load(path, function (gltf) {
            ...
            gltf.scene.traverse(o=>{
                if(o instanceof THREE.Mesh){                    
                    ...
                    mesh.name=o.name
                    // if(meshes.length<=88)mesh.visible=false
                    meshes.push(mesh)
                    console.log(mesh.name,self.config.iswall[mesh.name])
                    // mesh.visible=self.config.iswall[mesh.name]
                    o.parent.add(mesh)
                    o.visible=false
