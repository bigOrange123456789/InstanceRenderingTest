...
window.addEventListener("load",()=>{
    ...
    window.Terrain=addThreeTerrain();
    window["myObject"]["cameraMode"]="auto";
    addSceneSetupObject();
    let sendTimeToGPU=buildSendTimeToGPU();
    ...
    function re_Render(){
        ...
        if(sendTimeToGPU)sendTimeToGPU();
        forceRender();
    ...
    import("../myJs/myTerrain.js").then(function(mod){
        return mod.terrainDemoMain_fast(window.Terrain);
    }).then(function(){
