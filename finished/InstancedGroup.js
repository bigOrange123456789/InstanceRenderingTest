function InstancedGroup(){
    ...
    this.init=function (originMesh,animations){
        ...
        var type=new THREE.InstancedBufferAttribute(new Uint16Array(instanceCount*3), 3);

        for(var k=0,kl=33,il=instanceCount ,i=0;k<kl&&i<il;k++)
            for(var b=0,bl=33;b<bl&&i<il;b++,i++){
                mcol0.setXYZ(i, Math.random()/2+0.75,0,0);//随机长宽高
    ...
    this.positionSet=function (i,pos){//第几个对象，位置数组【x,y,z】
