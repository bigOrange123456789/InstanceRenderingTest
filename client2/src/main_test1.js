...
function syncClientDataToServer() {//发送视点信息
    ...
    msg[1] = Math.round()*50-50;
    msg[2] = Math.round()*50-50;
    msg[3] = Math.round()*50-50;

    msg[4] = Math.round()*6-3;//-camera.rotation.x * 57.29578;
    msg[5] = Math.round()*6-3;//camera.rotation.y * 57.29578;
    msg[6] = Math.round()*6-3;//camera.rotation.z * 57.29578;
