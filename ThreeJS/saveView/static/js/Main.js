function Main(){
    ...
    this.init=function()
    {
        this.renderer = new THREE.WebGLRenderer({ preserveDrawingBuffer: true,antialias: true, alpha: true});
        ...
        winWidth = 256//window.innerWidth;
        winHeight = 256//window.innerHeight;
