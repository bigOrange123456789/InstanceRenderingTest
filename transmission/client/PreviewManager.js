...
class PreviewManager{
    ...
    createCameraButton=function(src1,src2){
        var scope=this;
        scope.#cameraImg1=new MyImage(src1,window.innerHeight/13,window.innerHeight/13,window.innerWidth/25,window.innerHeight-240,document.body);
        scope.#cameraImg2=new MyImage(src2,window.innerHeight/13,window.innerHeight/13,window.innerWidth/25,window.innerHeight-240,document.body);
