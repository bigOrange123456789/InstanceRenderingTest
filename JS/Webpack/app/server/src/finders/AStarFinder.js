...
AStarFinder.prototype={
    ...
    computeWeight:function(node,neighbor){
        var scope=this;
        var board,dis_scope,board_id;
        [board,dis_scope,board_id]=getBoard(neighbor.x,neighbor.y);
        function getBoard(x2,y2) {//boards
            ...
            return [boards[k],scope.disScope[k],k];
        }
    ...
    computeWeight1:function(node,neighbor){
        var scope=this;
        var board,dis_scope;
