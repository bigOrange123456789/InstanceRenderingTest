 ...
 */
var View = {
    nodeSize: document.body.clientWidth/Controller.gridSize[0]>7?document.body.clientWidth/Controller.gridSize[0]:7, //7,// width and height of a single node, in pixel
    nodeStyle: {
        normal: {
            fill: 'white',
