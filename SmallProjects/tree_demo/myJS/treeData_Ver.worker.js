...
class TreeData{
    ...
    produceTreeGeo(style,level,barkMaterialID){
        //console.log(this);
        ...
        for(let branch of values){
            branch.produceBranchGeo(treeGroup,style,branch.layer,this.materials[barkMaterialID],0.2,false);
    ...
    updateLODAndFustumCulliing(camera,fustum){
        ...
        for(let tree of this.treeLib){
            ...
            for(let level of Object.keys(tree.branchesLibLOD)){ 
                ...
                for(let treeID of tree.InstanceID){
                            ...
                            boundingBox.applyMatrix4(treeInstanced.transformMatrix)
                             if(fustum.intersectsBox(boundingBox)){
                                ...
                                tree.branchesLibLOD["1"].setMatrixAt(index,treeInstanced.transformMatrix);
                                tree.branchesLibLOD["1"].count++;
