...
var Loader = function ( editor ) {
    ...
    this._handleJSON=function(data,beforeAddToScene){
	             handleJSON(data,beforeAddToScene);
   };
	function handleJSON( data,beforeAddToScene ) {
				...
				loader.parse( data, function ( result ) {
					...
					if ( result.isScene ) {
						...
						editor.execute( new SetSceneCommand( editor, result ) );
                             ...
                             if(beforeAddToScene)beforeAddToScene(result);
